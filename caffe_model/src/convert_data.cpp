// This script converts the dataset to a lmdb (default) or
...
void convert_dataset(const char* image_filename, const char* label_filename,
  ...
  std::cout << "magic1:" << magic << std::endl;

  label_file.read(reinterpret_cast<char*>(&magic), 4);
  //magic = swap_endian(magic);
  CHECK_EQ(magic, 2049) << "Incorrect label file magic.";

  std::cout << "magic2:" << magic << std::endl;
...
int main(int argc, char** argv) {
  ...
  gflags::SetUsageMessage("This script converts the dataset to\n"
  ...
  if (argc != 4) {
    gflags::ShowUsageWithFlagsRestrict(argv[0],
      "/home/nelson/TCC/caffe_model/bin/convert_data");
  } else {
